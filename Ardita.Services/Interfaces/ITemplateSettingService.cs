...
public interface ITemplateSettingService
{
    ...
    Task<int> Insert(MstTemplateSetting model, IFormFile file, Tuple<string[], string[], string[]> data);
    Task<bool> InsertBulk(List<MstTemplateSetting> MstTemplateSettings);
    Task<int> Delete(MstTemplateSetting model);
    Task<int> Update(MstTemplateSetting model, IFormFile file, Tuple<string[], string[], string[]> data);
