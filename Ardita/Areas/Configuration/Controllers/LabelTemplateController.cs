...
public class LabelTemplateController : BaseController<MstTemplateSetting>
{
    ...
    #endregion
    #region HELPER
    private RedirectToActionResult RedirectToIndex() => RedirectToAction(GlobalConst.Index, GlobalConst.LabelTemplate, new { Area = GlobalConst.Configuration });
    #endregion
}
