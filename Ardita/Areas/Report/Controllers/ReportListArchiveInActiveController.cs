...
namespace Ardita.Areas.Report.Controllers
{
    [CustomAuthorize]
    [Area("Report")]
    public class ReportListArchiveInActiveController : BaseController<ListArchiveInActiveParams>
    {
        ...
        public async Task<IActionResult> GenerateReport(ReportGlobalParams param)
        {
            ...
            var returnString = await _reportService.GenerateReportListArchiveInActive(reportName, param, AppUsers.CurrentUser(User));
