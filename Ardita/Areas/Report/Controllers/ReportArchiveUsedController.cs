...
namespace Ardita.Areas.Report.Controllers
{
    [CustomAuthorize]
    [Area("Report")]
    public class ReportArchiveUsedController : BaseController<ArchiveUsedParams>
    {
        ...
        public async Task<IActionResult> GenerateReport(ReportGlobalParams param)
        {
            ...
            var returnString = await _reportService.GenerateReportArchiveUsedAsync(reportName, param, AppUsers.CurrentUser(User));
