...
namespace Ardita.Areas.Report.Controllers
{
    [CustomAuthorize]
    [Area("Report")]
    public class ReportArchiveDestroyController : BaseController<ArchiveDestroyParams>
    {
        ...
        public async Task<IActionResult> GenerateReport(ReportGlobalParams param)
        {
            ...
            var returnString = await _reportService.GenerateReportArchiveDestroyAsync(reportName, param, AppUsers.CurrentUser(User));
