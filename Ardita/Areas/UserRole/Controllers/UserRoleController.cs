...
namespace Ardita.Areas.UserRole.Controllers
{
    [Authorize]
    [Area("UserRole")]
    public class UserRoleController : Controller
    {
        ...
        public async Task<IActionResult> Save(UserRoleListViewModel model)
        {
            ...
            return RedirectToAction("Detail", "UserRole", new { Area = "UserRole", id = model.UserRole.UserId });
        }
        ...
        public async Task<IActionResult> Remove(Guid id)
        {
            ...
            return RedirectToAction("Detail", "UserRole", new { Area = "UserRole", id=userRoleObj.UserId });
        }
    }
}
